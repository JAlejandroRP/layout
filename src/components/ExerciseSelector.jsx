...
export default function ExerciseSelector({ addExercise }) {
  const [selected, setSelected] = useState(people[0])
  const [query, setQuery] = useState('')

  useEffect(() => {
    addExercise(selected.name)
  }, [])

  const updateSelected = (selectd) => {
    console.log(selectd);
    setSelected(selectd)
    addExercise(selectd.name)
  }
